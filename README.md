...
Собрать схему с включением 3-и светодиодов и 4-х кнопок. Базовый функционал кнопок, указанный ниже, меняется кнопкой 4:
...
4) При нажатии меняет функционал у кнопок смещая цвет светодиода вниз по списку.
...
Файл отчёта лабораторной работы: [МПиМК_ЛБ1_.pdf](МПиМК_ЛБ1_.pdf)

Файл схемы электрической принципиальной Э3: [Схема_электрическая_принципиальная_Э3_ФЮРА_XXXXXX_001_Э3.pdf](Схема_электрическая_принципиальная_Э3_ФЮРА_XXXXXX_001_Э3.pdf)

Ссылка на отчёт (МПиМК_ЛБ1): https://docs.google.com/document/d/1uGTj72RaL2Ql8QpoRShqb0rrj9pW_L_ZHwh8-em5PwQ/edit?tab=t.0

## Дополнительное задание

Режим работы кнопки №1
- Короткое нажатие: меняет частоту моргания светодиода в 3 значениях (редко, часто, очень часть)
- Длинное нажатие: переключает светодиод(ы) на один вниз по списку 
- Кнопка не включает светодиод, только настраивает
- Светодиоды могут гореть с разной частотой

Режим работы кнопки №2
- Единичное нажатие: загорается один светодиод (при горении трёх - выключает)

## Информация от автора исходного репозитория
