...
int main(void) {
    *(uint32_t *)(0x40023800UL + 0x30UL) |= 0x02; //Включение тактирования на GPIOBEN (светодиод PB13) (1 << 1)

    *(uint32_t *)(0x40020400UL + 0x00UL) |= 0x10000000; // Режим порта (1 << 27)
    ...
    *(uint32_t *)(0x40020400UL + 0x04UL) |= 0x00; // настройка режима порта 
     // Output Push-Pull (PP) 0 – Стандартный двухтактный выход.
     // Output Open-Drain (OD) 1 – Выход с открытым стоком.

    *(uint32_t *)(0x40020400UL + 0x08UL) |= 0x10000000; // скорость одного бита (1 << 27)
    ...
    *(uint32_t *)(0x40020400UL + 0x0CUL) |= 0x00; // настройка подтяжки
